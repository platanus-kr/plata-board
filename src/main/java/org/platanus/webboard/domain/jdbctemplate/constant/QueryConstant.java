package org.platanus.webboard.domain.jdbctemplate.constant;
...
public class QueryConstant {
    ...
    public static final String ARTICLE_DELETE_BY_BOARD_ID = "delete from ARTICLES where BOARD_ID = ?";
    ...
    public static final String USER_UPDATE = "update users set USERNAME =?, PASSWORD = ?, NICKNAME = ?, EMAIL = ?, ROLE = ? where ID = ?";
